## In Class Probabilty 3
## Lina Clifford

# Question 2
Quest2Prob4of6 <- dbinom(x = 4, size = 6, prob = 0.66, log = FALSE)
print(Quest2Prob4of6)

# Question 3
Quest3Prob0 <- dbinom(x = 0, size = 7, prob =4/6)
...
# Question 7
Que7 <- pnorm(1, mean = 0, sd = 1)
print(Que7)

# Question 8
Q8 <- pnorm(2, mean = 0, sd =1)
Q8 - Que7
